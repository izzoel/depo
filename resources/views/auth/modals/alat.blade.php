            ...
            <div class="modal-body">
                <div class="nav-align-top mb-4">
                    <ul class="nav nav-tabs nav-fill" role="tablist">
                        <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#nav-alat" aria-controls="nav-alat"
                                aria-selected="true">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="nav-alat" role="tabpanel">
                            <form action="{{ route('alat_store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label" for="depo_alat">Nama Alat<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="depo_alat" name="nama" placeholder="Pinset" required />
                                </div>
                                <div class="mb-3">
...
<div class="modal modalUpdate fade" id="M_U_alat" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="tab-pane fade show active" id="nav-alat" role="tabpanel">
                        <form id="U_route" action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="U_nama" name="nama" placeholder="Pinset" required />
                            </div>
                            <div class="mb-3">
...
<div class="modal modalDelete fade" id="M_D_alat" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete_alat">Konfirmasi Hapus</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
